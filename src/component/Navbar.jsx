...
const Navbar = () => {
  ...
  return (
    <nav>
    <div className='flex justify-around h-24 bg-green-700 '>
        ...
        <div className={`${showNav ? 'block' : 'hidden'} md:hidden bg-blue absolute top-24 w-full z-10`}>
           ...
           <span className='m-4 text-white font-semibold cursor-pointer'>Our Story</span>
            <span className='m-4 text-dirtWhite font-semibold cursor-pointer'>Membership</span>
            <span className='m-4 text-dirtWhite font-semibold cursor-pointer'>Write</span>
            <span className='m-4 text-dirtWhite font-semibold cursor-pointer'>Sign in</span>
        

           </div>
        </div>
        <div className=' mt-8 hidden md:block'>
            <span className='m-4 text-dirtWhite font-semibold cursor-pointer'>Our Story</span>
            <span className='m-4 text-dirtWhite font-semibold cursor-pointer'>Membership</span>
            <span className='m-4 text-dirtWhite font-semibold cursor-pointer'>Write</span>
            <span className='m-4 text-dirtWhite font-semibold cursor-pointer'>Sign in</span>
